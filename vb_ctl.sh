...
do
   ...
   case $key in
	...
	;;
	  ...
	  echo "	 -b|--begin. Begins specific virtual machine, after -b must be number of vm from existing virtual machines list."
	  echo "	 -d|--delete. Delete specific virtual machine, after -d must be number of vm from existing virtual machines list."
	  echo "	 -c|--clone. Clone (and --register) specific virtual machine, after -c must be number of vm from existing virtual machines list. "
	  echo "	 -r|--resume. Resume specific virtual machine, after -r must be number of vm from running virtual machines list."
	  echo "	 -p|--pause. Pause specific virtual machine, after -p must be number of vm from running virtual machines list."
	  echo "	 -s|--stop. Stops=savestate  specific virtual machine, after -s must be number of vm from running virtual machines list."
	  echo "	 -P|--Poweroff. Stops=poweroff  specific virtual machine, after -P must be number of vm from running virtual machines list."
	  echo "	 -t|--turn. Stops=reset  specific virtual machine, after -t must be number of vm from running virtual machines list."	  
	  echo "	 -l|--list. List all existing virtual machines."	  
	  echo "	 -L|--List. List all currently running virtual machines."	  
	  echo "	 -i|--info. Shows info about specific virtual machine, after -i must be number of vm from existing virtual machines list."
